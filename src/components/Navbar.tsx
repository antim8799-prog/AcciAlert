...
import { AlertCircle, Menu, X, PhoneCall, Moon, Sun } from 'lucide-react';
import accialertLogo from '../assets/accialert-logo.png';
        ...
        <div className="flex h-16 sm:h-20 items-center justify-between">
          ...
          >
            <img
              src={accialertLogo}
              alt="AcciAlert"
              className="h-12 w-[38px] rounded-md object-cover shadow-sm transition-transform group-hover:scale-[1.03] sm:h-14 sm:w-11"
            />
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.label}
                  to={link.href}
                  className={`px-3 py-2 text-sm font-semibold rounded-md transition-colors ${location.pathname === link.href
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-lg text-neutral-700 hover:bg-neutral-100 hover:text-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 dark:text-neutral-300 dark:hover:bg-neutral-800"
          ...
          <div className="flex md:hidden items-center gap-2">
            <button
              type="button"
              onClick={onToggleDarkMode}
              className="p-2.5 rounded-lg text-neutral-700 hover:bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-neutral-400 dark:text-neutral-300 dark:hover:bg-neutral-800"
              aria-label={isDarkMode ? 'Switch to light mode' : 'Switch to dark mode'}
            >
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  className={`block px-4 py-3 rounded-lg text-base font-semibold ${location.pathname === link.href
