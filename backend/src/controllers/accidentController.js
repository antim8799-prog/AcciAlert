...
//❤️ add rough data for demo purpose only 
...
const demoAccidents = [
  {
    ...
    severity: 'critical',
    injuredPeople: 2,
    description: 'Two cars collided near Connaught Place. One lane is blocked and first aid may be needed.',
    location: { latitude: 28.6315, longitude: 77.2167 },
    photo: null,
    reporter: { name: 'Demo Reporter', phone: '' },
    status: 'responding',
    confirmations: 4,
    disputes: 0,
  ...
  },
  {
    ...
    severity: 'moderate',
    injuredPeople: 1,
    description: 'Motorcycle slip near India Gate. The rider is conscious and pedestrians are keeping the area clear.',
  ...
  },
  {
    ...
    severity: 'critical',
    injuredPeople: 1,
    description: 'Pedestrian incident at the Saket crossing. Traffic is slowing in both directions.',
    location: { latitude: 28.5245, longitude: 77.2066 },
    photo: null,
    reporter: { name: 'Demo Reporter', phone: '' },
    status: 'under_review',
    confirmations: 2,
  ...
  },
  {
    ...
    severity: 'low',
    injuredPeople: 0,
    description: 'Minor road accident near Rohini Sector 10. Vehicles have moved to the roadside.',
...
memoryAccidentStore.push(...demoAccidents);
//demo data  till here ❤️
