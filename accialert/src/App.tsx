...
export default function App() {
  ...
  return (
    <BrowserRouter>
      <div className="min-h-screen flex flex-col bg-neutral-50 text-neutral-900 selection:bg-red-100 selection:text-red-900">
        {/* Top Navbar */}
        <Navbar onOpenEmergencyModal={openEmergencyModal} />
